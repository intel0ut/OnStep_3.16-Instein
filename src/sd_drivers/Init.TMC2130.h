// TMC2130 stepper driver init
  ...
  #define AXIS1_DRIVER_SUBMODEL TMC2130
    ...
    #warning "Configuration (Config.xxx.h): AXIS1 TMC2130, use Vref=1.2V and be sure AXIS1_DRIVER_IRUN matches your stepper motor's current rating"
  #elif AXIS1_DRIVER_IRUN != OFF || AXIS1_DRIVER_IGOTO != OFF || AXIS1_DRIVER_IHOLD != OFF
    #warning "Configuration (Config.xxx.h): AXIS1 TMC2130, use Vref=1.2V and be sure AXIS1_DRIVER_IRUN, AXIS1_DRIVER_IGOTO, and AXIS1_DRIVER_IHOLD are all set properly for your stepper motor."
  #else
    #warning "Configuration (Config.xxx.h): AXIS1 TMC2130, set Vref to match your stepper motor's current rating."
  #endif
#endif
  ...
  #define AXIS2_DRIVER_SUBMODEL TMC2130
    ...
    #warning "Configuration (Config.xxx.h): AXIS2 TMC2130, use Vref=1.2V and be sure AXIS2_DRIVER_IRUN matches your stepper motor's current rating."
  #elif AXIS2_DRIVER_IRUN != OFF || AXIS2_DRIVER_IGOTO != OFF || AXIS2_DRIVER_IHOLD != OFF
    #warning "Configuration (Config.xxx.h): AXIS2 TMC2130, use Vref=1.2V and be sure AXIS2_DRIVER_IRUN, AXIS2_DRIVER_IGOTO, and AXIS2_DRIVER_IHOLD are all set properly for your stepper motor."
  #else
    #warning "Configuration (Config.xxx.h): AXIS2 TMC2130, set Vref to match your stepper motor's current rating."
  #endif
#endif
    ...
    #define AXIS3_DRIVER_MODEL TMC_SPI
      ...
      #warning "Configuration (Config.xxx.h): AXIS3 TMC2130, use Vref=1.2V and be sure AXIS3_DRIVER_IRUN is set properly for your power supply, voltage regulator, and stepper motor limits."
    #elif AXIS3_DRIVER_IRUN != OFF || AXIS3_DRIVER_IHOLD != OFF
      #warning "Configuration (Config.xxx.h): AXIS3 TMC2130, use Vref=1.2V and be sure AXIS3_DRIVER_IRUN and AXIS3_DRIVER_IHOLD are set properly for your power supply, voltage regulator, and stepper motor limits."
    #else
      #warning "Configuration (Config.xxx.h): AXIS3 TMC2130, set Vref to match your stepper motor's current rating."
    #endif
  #endif
#endif
    ...
    #define AXIS4_DRIVER_SUBMODEL TMC2130
      ...
      #warning "Configuration (Config.xxx.h): AXIS4 TMC2130, use Vref=1.2V and be sure AXIS4_DRIVER_IRUN is set properly for your power supply, voltage regulator, and stepper motor limits."
    #elif AXIS4_DRIVER_IRUN != OFF || AXIS4_DRIVER_IHOLD != OFF
      #warning "Configuration (Config.xxx.h): AXIS4 TMC2130, use Vref=1.2V and be sure AXIS4_DRIVER_IRUN and AXIS4_DRIVER_IHOLD are set properly for your power supply, voltage regulator, and stepper motor limits."
    #else
      #warning "Configuration (Config.xxx.h): AXIS4 TMC2130, set Vref to match your stepper motor's current rating."
    #endif
  #endif
#endif
    ...
    #define AXIS5_DRIVER_SUBMODEL TMC2130
      ...
      #warning "Configuration (Config.xxx.h): AXIS5 TMC2130, use Vref=1.2V and be sure AXIS5_DRIVER_IRUN is set properly for your power supply, voltage regulator, and stepper motor limits."
    #elif AXIS5_DRIVER_IRUN != OFF || AXIS5_DRIVER_IHOLD != OFF
      #warning "Configuration (Config.xxx.h): AXIS5 TMC2130, use Vref=1.2V and be sure AXIS5_DRIVER_IRUN and AXIS5_DRIVER_IHOLD are set properly for your power supply, voltage regulator, and stepper motor limits."
    #else
      #warning "Configuration (Config.xxx.h): AXIS5 TMC2130, set Vref to match your stepper motor's current rating."
    #endif
  #endif
#endif
