...
#define AXIS1_STEPS_PER_DEGREE        12800.0         // (Stepper_steps * micro_steps * overall_gear_reduction)/360.0 
#define AXIS1_STEPS_PER_WORMROT       25600          // (AXIS1_STEPS_PER_DEGREE*360)/reduction_final_stage (PEC Eq mode only)
#define AXIS1_DRIVER_MODEL            TMC5160_QUIET // OFF, (See above.) Stepper driver model.
#define AXIS1_DRIVER_MICROSTEPS       64             // OFF, n. Microstep mode when tracking. 
...
#define AXIS2_STEPS_PER_DEGREE        12800.0         // (Stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS2_DRIVER_MODEL            TMC5160_QUIET // OFF, (See above.) Stepper driver model.
#define AXIS2_DRIVER_MICROSTEPS       64             // OFF, n. Microstep mode when tracking.
