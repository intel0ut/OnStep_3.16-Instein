...
// help with commands
enum Command {COMMAND_NONE, COMMAND_SERIAL_A, COMMAND_SERIAL_B, COMMAND_SERIAL_C, COMMAND_SERIAL_D, COMMAND_SERIAL_ST4, COMMAND_SERIAL_X};
...
#ifdef HAL_SERIAL_D_ENABLED
      if (process_command == COMMAND_SERIAL_D) {
        if (commandError != CE_NULL) cmdD.lastError=commandError;
