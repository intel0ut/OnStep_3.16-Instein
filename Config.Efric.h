...
#define AXIS1_STEPS_PER_DEGREE        8533.4         // (Stepper_steps * micro_steps * overall_gear_reduction)/360.0 
#define AXIS1_STEPS_PER_WORMROT       6400           // (AXIS1_STEPS_PER_DEGREE*360)/reduction_final_stage (PEC Eq mode only)
...
#define AXIS1_DRIVER_IHOLD            600            // OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    
#define AXIS1_DRIVER_IRUN             800            // OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    
#define AXIS1_DRIVER_IGOTO            1200            // OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    
...
#define AXIS2_DRIVER_IHOLD            600            // OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    
#define AXIS2_DRIVER_IRUN             800            // OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    
#define AXIS2_DRIVER_IGOTO            1200            // OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    
