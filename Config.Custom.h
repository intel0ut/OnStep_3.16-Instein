...
// Configuration for Instein ESP32 Custom Drive with TMC5160 stepper drivers
// https://instein.eu/index.php?route=product/product&path=25&product_id=72
...
#define MOUNT_TYPE                    GEM // GEM, GEM for German Equatorial, FORK for Equatorial Fork, or ALTAZM for dobsonian-style mounts.         
...
#define AXIS1_STEPS_PER_WORMROT       12800          // (AXIS1_STEPS_PER_DEGREE*360)/reduction_final_stage (PEC Eq mode only)
...
#define AXIS1_DRIVER_IHOLD            200            // OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    
#define AXIS1_DRIVER_IRUN             400            // OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc. This setting usually should be about 60-70% of motor current ratting.   
#define AXIS1_DRIVER_IGOTO            600            // OFF, n, (mA.) Current during slews. OFF uses same as IRUN. This setting should not be higher than your motor current rating.                   
...
#define AXIS2_DRIVER_IHOLD            200            // OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    
#define AXIS2_DRIVER_IRUN             400            // OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc. This setting usually should be about 60-70% of motor current ratting.     
#define AXIS2_DRIVER_IGOTO            600            // OFF, n, (mA.) Current during slews. OFF uses same as IRUN. This setting should not be higher than your motor current rating.                    
