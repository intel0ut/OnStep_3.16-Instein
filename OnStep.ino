...
//****************************************************************************************************************************************
#define Mount_G8     // <--- HERE MUST BE DEFINED ONLY SINGLE MAIN FIRMWARE TO UPLOAD FROM THE OPTIONS BELOW (Case sensitive)

// Mount_AZ8              Instein GoTo kit main firmware for AZ8 (with Instein supplied motors 17HM15-0904S and TMC5160 s.drivers) Edit Config.AZ8.h tab
// Mount_Custom           Custom options for mounts that are not listed here or testing purposes. Edit Config.Custom.h tab
// Mount_EQ5              Instein GoTo kit main firmware for EQ5 (with Instein supplied motors 17HM15-0904S and TMC5160 s.drivers). Edit Config.EQ5.h tab
// Mount_Efric            Instein Custom Drive firmware for Gemini E.fric (with Gemini Stock motors 1,5A and TMC5160 s.drivers) Edit Config.Efric.h tab
// Mount_G11              Instein GoTo kit main firmware for G11/HGM200 (with Instein supplied motors 17HM15-0904S and TMC5160 s.drivers). Edit Config.G11.h tab
// Mount_G8               Instein GoTo kit main firmware for G8 (with Instein supplied motors 17HM15-0904S and TMC5160 s.drivers). Edit Config.G8.h tab
// Mount_StockEQ5         Instein Custom Drive main firmware for EQ5 with Skywatcher Nema14 Stock motors and TMC5160 s.drivers. Edit Config.StockEQ5.h tab
// Mount_Titan            Instein Drive main firmware for Titan (with Instein supplied motors 17HM15-0904S and TMC5160 s.drivers). Edit Config.Titan.h tab
//**************************************************************************************************************************************** september 6
...
//Firmware selection preprocessor
#ifdef Mount_AZ8
#include "Config.AZ8.h"
#endif
#ifdef Mount_Custom
#include "Config.Custom.h"
#endif
#ifdef Mount_EQ5
#include "Config.EQ5.h"
#endif
#ifdef Mount_Efric
#include "Config.Efric.h"
#endif
#ifdef Mount_G11
#include "Config.G11.h"
#endif
#ifdef Mount_G8
#include "Config.G8.h"
#endif
#ifdef Mount_StockEQ5
#include "Config.StockEQ5.h"
#endif
#ifdef Mount_Titan
#include "Config.Titan.h"
#endif
