...
#define SLEW_RATE_BASE_DESIRED        1.0 //    1.0, n.  Desired slew rate in deg/sec.(1deg/s = 240x) Adjustable at run-time from      
...
#define AXIS1_STEPS_PER_DEGREE        9600.0         // (Stepper_steps * micro_steps * overall_gear_reduction)/360.0 
...
#define AXIS1_DRIVER_IRUN             OFF            // OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    
#define AXIS1_DRIVER_IGOTO            OFF            // OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    
...
#define AXIS2_STEPS_PER_DEGREE        9600.0         // (Stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_DRIVER_IRUN             OFF            // OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    
#define AXIS2_DRIVER_IGOTO            OFF            // OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    
