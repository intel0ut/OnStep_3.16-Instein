...
#define AXIS1_STEPS_PER_DEGREE        9395.2         // (Stepper_steps * micro_steps * overall_gear_reduction)/360.0 
#define AXIS1_STEPS_PER_WORMROT       23488          // (AXIS1_STEPS_PER_DEGREE*360)/reduction_final_stage (PEC Eq mode only)
...
#define AXIS2_STEPS_PER_DEGREE        9395.2         // (Stepper_steps * micro_steps * overall_gear_reduction)/360.0
